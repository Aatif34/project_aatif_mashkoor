...
```bash
git clone https://github.com/Aatif34/project_aatif_mashkoor.git
...
- Training was done on Google Colab with a T4 GPU
- Images are resized to 224×224 before being passed to the model
- The final layer of ResNet50 was replaced to output 25 classes instead of 1000
- Data augmentation was applied during training — flipping, rotation, brightness adjustment
